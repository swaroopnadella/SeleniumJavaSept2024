...
public class SVG_ElementsDemo3 {
	...
	public static void main(String[] args) {
		...
		List<WebElement> svg_Elements = driver.findElements(By.xpath("//*[name()='svg']//*[local-name()='path']"));
		System.out.println(svg_Elements.size());
		System.out.println("***********");
		for(WebElement ele:svg_Elements) {
			System.out.println(ele.getDomAttribute("d"));
		}
		driver.quit();
	}
